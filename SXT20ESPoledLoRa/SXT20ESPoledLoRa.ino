 ...
 *Скетч змінено для використання з модулем TTGO для датчика SHT20 задействовани піни:4=жовтий 15=блакитний GND=чорний 3.3=корічневий
 *
 *******************************************************************************/
#include <lmic.h>
#include <hal/hal.h>
...
/*Куда це вставити, щоб esp засинала після успішной передачи даних?
// deep sleep
...
static const u1_t PROGMEM DEVEUI[8] = { 0x4E, 0x4E, 0x04, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

// This key should be in big endian format (or, since it is not really a
// number but a block of memory, endianness does not really apply). In
// practice, a key taken from the TTN console can be copied as-is.
static const u1_t PROGMEM APPKEY[16] = { 0x1E, 0xA6, 0x97, 0x9A, 0x1D, 0x27, 0xD4, 0x0D, 0xFD, 0x16, 0x18, 0x4B, 0xB0, 0x50, 0xA3, 0x57 };
...
void setup() {
    ...
    Serial.println("OLED and SHT20 init'd");
